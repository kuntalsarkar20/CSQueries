				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6" style="border:px solid black;">
						<div class="col-sm-12" style="padding:0px 20px;border:px solid black;">
							 <a href="" class="links-col"><span class="glyphicon glyphicon-pencil" style="top:90px;left: 180px;"></span></a><center><img src="avatar-367-456319.png" alt="John" style="width:30%"></center>
							 <h1 style="font-size: 30px;font-family:Helvetica;"><B>Kuntal Sarkar</B></h1>
							 <h2 style="font-family:OpenSans;font-size: 20px;">@kuntal_sarkar</h2>
							  <a href="" class="profile-links-col" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-pencil"></span> Edit Info</a>
							  <hr>
							  <ul style="padding: 0px;"><li>Completed gradutaion in BCA at 2019</li><li>Pursuing MCA</li></ul>
						</div>
					</div>
					...
					<div class="col-lg-8 col-md-8 col-sm-12" style="border:px solid black;">
						<div class=" col-sm-12 box2" style="padding: 20px;" >
							...
							<br><a href="" class="profile-links-col" data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-pencil" style="float: right;"></span></a> &nbsp; &nbsp;	Computer Science, MCA | July 2019 - Present</h2>
							<br><hr>
						</div>
					</div>	
					<div class="col-lg-4 col-md-4 col-sm-12">
						...
						<div class="col-lg-8 col-md-8 col-sm-12" style="border:px solid black; padding:50px 10px;">
							...
							<div class="col-sm-12 box2" style="padding:0px 30px;">
								...
								<ul style="padding: 0px;"><li>C</li>
								<li>C++</li>
								<li>Java</li>
								<li>Data Structure</li></ul>
									<hr>
							</div>
						</div>
						</div>
