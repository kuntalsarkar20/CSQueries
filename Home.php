...
<section style="padding: 50px 0px;" id="about-Section">
	<div class="container">
		<center><h1 style="font-weight: bold;"><span style="border-bottom:3px solid black;">CSQueries</span></h1></center>
		...
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12 about-section-img-con" data-aos="fade-up" data-aos-duration="2000">
				<div class="card" style="padding: 20px 0px 20px 0px;border-radius: 20px 0px 20px 0px;">
				  <center><img src="write_for_us_2.png" class="about-section-img" alt="John" style="width:80%;height:180px;"></center>
				  <h1 >Write For Us</h1>
			...
			<div class="col-lg-3 col-md-3 col-sm-12" data-aos="fade-up" data-aos-duration="2000">
				<div class="card" style="border-radius: 20px 0px 20px 0px;">
				  <img src="search_here.png" alt="John" style="width:100%;height:200px;">
				  <h1>Find Answers Quickly</h1>
...
<div class="container">
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-3" style="padding: 20px;">
				<img src="avatar-367-456319.png" alt="jana" style="width: 200px;border-radius: 25%;">
			</div>
